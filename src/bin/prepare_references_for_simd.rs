...
use backend_showdown_2026::{DIMENSIONS, LABELS_PATH, OFFSET, SCALE, VECTORS_PATH, LANES};
...
fn main() {
    ...
    println!("vectors written to {}.simd", VECTORS_PATH);
    println!("labels written to {}.simd", LABELS_PATH);
}